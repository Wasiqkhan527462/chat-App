...
const Signup = () => {
  ...
  const postDetails = (pics) => {
    ...
    if (pics === undefined) {
      toast({
        ...
        description: "Please select a picture for your account.",
        status: "warning",
        duration: 5000,
        isClosable: true,
        position: "bottom",
    ...
    if (pics.type === "image/jpeg" || pics.type === "image/png") {
      ...
      data.append("cloud_name", "ddmbwnil4");

      fetch("https://api.cloudinary.com/v1_1/ddmbwnil4/image/upload", {
        method: "post",
        body: data,
      })
        .then((res) => res.json())
  ...
  return (
    <VStack spacing="10px" p={5} borderRadius="lg" boxShadow="md">
